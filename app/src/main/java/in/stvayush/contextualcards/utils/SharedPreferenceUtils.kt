...
object SharedPreferenceUtils {
  ...
  /**
   * Function used to save groupId locally using a [String] of Id(s) separated by commas[','] which
   * takes @param [groupId], the Id of a [CardGroup] that needs to be excluded
   */
  ...
  /**
   * Functions to check if specific group needs to be excluded or not which takes one parameter:
