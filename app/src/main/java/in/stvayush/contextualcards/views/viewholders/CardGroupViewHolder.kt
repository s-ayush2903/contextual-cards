...
/**
 * A ViewHolder that exposes the recyclerView associated to it and helps completing the Adapter
 * Pattern (for displaying views in recyclerViews using adapters & ViewHolders)
 */
